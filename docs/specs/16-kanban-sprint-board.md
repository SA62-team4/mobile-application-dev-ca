...
| S-03 | Private + Standout | In-app "your data stays on this device — AI runs locally" privacy screen + delete-account / export-data endpoint. Converts the privacy architecture into visible marks | M4 + M1 | 3 |
